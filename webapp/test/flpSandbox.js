		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comappapicalls-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappapicalls-display": {
								"semanticObject": "comappapicalls",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.apicalls",
									"url": sap.ui.require.toUrl("com/app/apicalls")
								}
							}
						}
					}
